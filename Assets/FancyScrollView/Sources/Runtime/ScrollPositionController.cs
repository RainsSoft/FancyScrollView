...
namespace FancyScrollView {
    public class ScrollPositionController : UIBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler {
        [SerializeField,Header("FancyScrollView.cellContainer")]
        internal RectTransform viewport = null;
        [SerializeField]
        internal ScrollDirection directionOfRecognize = ScrollDirection.Vertical;
        [SerializeField]
